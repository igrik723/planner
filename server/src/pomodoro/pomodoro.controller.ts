import { Put, Body, Controller, Get, HttpCode, UsePipes, ValidationPipe, Post, Param, Delete } from '@nestjs/common';
...
export class PomodoroController {
  ...
  @Put('/round/:id')
  @Auth()
  async upadteRound(@Param('id') id: string, @Body() dto: PomodoroRoundDto) {
